	...
	<div class="limiter">
		...
		<div class="container-login100">
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="script_reset_password2.php?t=<?php echo $t ?>&key=DpNhmLsWnSpwShZ6jlPhK3g5DEajmvTpX7HzfBMeG3L5CQDTc3LlqoomLklp">
