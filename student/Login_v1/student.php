						...
						<div class="col">
						   <div class="card" style="width:300px">
									...
									<div class="card-body">
									  ...
									  <a href="reset_password2.php?t=<?php echo $row['token']; ?>&key=DpNhmvTpX7HzfBMeG3L5CQDTc3LlqoomLklp" class="btn btn-primary">Change Password</a>
									</div>
									</div>
						</div>
						<div class="col">
							<div class="card">
										<div class="card-body">
										  ...
										  <h4 class="card-title">Roll No: <?php echo "&#160; ".$row['rollno']; ?></h4>
