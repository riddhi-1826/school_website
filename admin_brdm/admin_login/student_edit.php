		...
		<div class="container-login100">
			...
			<div class="wrap-login100">
				...
				<?php
					$id = $_GET['id'];
				?>
				<form class="login100-form validate-form" method="post" action="script_student_edit.php?id=<?php echo $id;?>">
					...
					<div class="wrap-input100 validate-input" data-validate = "Name is required">
						<input class="input100" type="text" name="name" placeholder="Name" value="<?php echo $student['name']; ?>">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid phone number is required">
						<input class="input100" type="number" name="phone" placeholder="Phone No" value="<?php echo $student['phone']; ?>">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
				...
				<!-- 	<div class="wrap-input100 validate-input" data-validate = "Valid email is required: john@abc.xyz">
						...
						<input class="input100" type="text" name="class" placeholder="Class" value="<?php echo $student['class']; ?>">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="wrap-input100 validate-input" data-validate = "Roll No. is required">
						<input class="input100" type="text" name="rollno" placeholder="Roll No." value="<?php echo $student['rollno']; ?>">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
...
<!-- 
					...
					<!-- <div>	
					 ...
					 <div class="text-center p-t-136">
						<a class="txt2" href="../admin_panel/view_students.php">
							GO BACK
