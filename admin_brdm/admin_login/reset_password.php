...
<body>
 ...
 -->
				...
				<form class="login100-form validate-form" method="post" action="script_reset_password.php">
					<span class="login100-form-title ">
						Reset Your Password
					</span>
		
					<div class="wrap-input100 validate-input" data-validate = "Current password is required">
						<input class="input100" type="text" name="currentpass" placeholder=" Current Password">
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="../admin_panel/admin.php">
							GO BACK
